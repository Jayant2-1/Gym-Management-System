      ...
      <div className="card">
        ...
        >
          ...
          <div className="md:col-span-2">
            ...
            <textarea className="input" rows={4} value={form.message} onChange={(e) => setForm((s) => ({ ...s, message: e.target.value }))} required />
          </div>
          <div>
                  ...
                  <button
                    onClick={() => {
                      if (isExpanded) {
                        ...
                        api.get(`/api/me/tickets/${tid}/replies`).then((r) => setReplies(r.data || [])).catch(() => setReplies([]));
                      }
                    }}
                  ...
                  >
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="flex flex-col items-end gap-2">
                        <span className={`inline-flex px-2 py-1 rounded-lg text-xs border ${
